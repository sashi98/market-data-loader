...
REQUIRED_KEYS = [
    ...
    "POSTGRES_PASSWORD",
    "TMT_APP_BASE_URL",
    "DATA_MARKET_DATA_LOADER_BHAV_COPY_DOWNLOAD_DIR",
    # RENAMED 2026-08-30 from MARKET_DATA_LOADER_DOWNLOAD_DIR, then RENAMED
    # AGAIN 2026-09-13 from BHAV_COPY_CSV_DOWNLOAD_DIR to carry the DATA_
    # prefix and component name, as part of the data/ directory redesign
    # (tmt's manual "Process BhavCopy" upload now gets its own dedicated
    # DATA_TMT_BACKEND_BHAV_COPY_UPLOAD_DIR instead of sharing this one).
    # This is specifically where bhav copy CSVs get downloaded to, not a
    # general-purpose market-data-loader directory. Read by
    ...
    # (harmless -- same as DATA_MARKET_DATA_LOADER_BHAV_COPY_DOWNLOAD_DIR
    # already being required even for listeners that don't use it) since
    # this file is shared across all of them.
    "TMT_ADMIN_USER_ID",
    "TMT_ADMIN_PASSWORD",
]
